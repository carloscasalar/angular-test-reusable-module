		...
		*/
		grunt.initConfig({
			...
			uglify: {
				...
				build: {
					files:  {},
					src:    'ar.test-reusable-module.js',
					dest:   'ar.test-reusable-module.min.js'
				}
			},
			less: {
				development: {
					...
					files: {
						"main.css": "_base.less",
						"ar.test-reusable-module.css": "_ar.test-reusable-module.less"
					}
				}
			},
			cssmin: {
				dev: {
					src: ['ar.test-reusable-module.css'],
					dest: 'ar.test-reusable-module.min.css'
				}
			}/*,
			karma: {
				unit: {
